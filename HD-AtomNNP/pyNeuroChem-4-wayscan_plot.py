...
produce_scan(axes.flat[3],'Lisdexamfetamine NCCC dihedral rotation',      'Angle ($^\circ$)',cnstfile1,saefile1,nnfdir1,dtdir4,'butane_dihedral_DFT.dat'   ,'butane_dihedral_AM1.dat'   ,'butane_dihedral_PM6.dat'  ,0,144,2.5,0.0)
