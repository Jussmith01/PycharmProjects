...
dir = '/Research/ANN-Test-Data/GDB-11-W98XD-6-31gd/train_04/'
...
plt.plot(data4[:,0], data4[:,1],'r--', color='green', label='ANN - GDB-5 RMSE: ' + "{:.6f}".format(rmse5) + "Ha/atom",linewidth=2)
plt.scatter(data4[:,0], data4[:,1], color='green',linewidth=4)
plt.plot(data5[:,0], data5[:,1],'r--', color='red', label='ANN - GDB-6 RMSE: ' + "{:.6f}".format(rmse6) + "Ha/atom",linewidth=2)
plt.scatter(data5[:,0], data5[:,1], color='red',linewidth=4)
