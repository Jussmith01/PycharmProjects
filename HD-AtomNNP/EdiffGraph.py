...
file = 'gdb11_s05-0_test.dat_graph'
...
rmse5 = gt.calculaterootmeansqrerror(data2[:,1],data3[:,1]) / 16.0
rmse6 = gt.calculaterootmeansqrerror(data2[:,1],data4[:,1]) / 16.0
...
plt.plot(data3[:,0], data3[:,1],'r--', color='blue', label='ANN - GDB-5 RMSE: ' + "{:.6f}".format(rmse5) + "Ha/atom",linewidth=2)
plt.scatter(data3[:,0], data3[:,1], color='blue',linewidth=4)
plt.plot(data4[:,0], data4[:,1],'r--', color='red', label='ANN - GDB-6 RMSE: ' + "{:.6f}".format(rmse6) + "Ha/atom",linewidth=2)
