...
dir1 = '/Research/ANN-Test-Data/GDB-11-W98XD-6-31gd/train_05/'
...
rmse61 = gt.calculaterootmeansqrerror(data2[:,1],data4[:,1]) / 63.0
rmse62 = gt.calculaterootmeansqrerror(data2[:,1],data5[:,1]) / 63.0
...
plt.plot(data5[:,0], data5[:,1],'r--', color='green', label='ANN - GDB-62 RMSE: ' + "{:.6f}".format(rmse61) + "Ha/atom",linewidth=2)
plt.scatter(data5[:,0], data5[:,1], color='green',linewidth=4)
plt.plot(data6[:,0], data6[:,1],'r--', color='orange', label='ANN - GDB-62 RMSE: ' + "{:.6f}".format(rmse62) + "Ha/atom",linewidth=2)
plt.scatter(data6[:,0], data6[:,1], color='orange',linewidth=4)
plt.plot(data6[:,0], data6[:,1],'r--', color='blue', label='ANN - GDB-6AA RMSE: ' + "{:.6f}".format(rmse6AA) + "Ha/atom",linewidth=2)
plt.scatter(data6[:,0], data6[:,1], color='blue',linewidth=4)
