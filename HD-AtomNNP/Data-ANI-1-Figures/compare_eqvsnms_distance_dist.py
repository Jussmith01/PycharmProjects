...
pld1 = get_distance_data(data1,spec1,an1,an2,0.05)
pld2 = get_distance_data(data2,spec2,an1,an2,1.0)
...
x1, y1, p1 = axes.hist(pld1, 400, color='blue', normed=True, linewidth=2, range=[1.1, 4.6])
...
x2, y2, p2 = axes.hist(pld2, 400, color='yellow',alpha=0.5, normed=True, label='MIN', linewidth=2, range=[1.1, 4.6])
